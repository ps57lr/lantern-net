...
```json
{
  ...
  "report_id": "report-20260816-0001",
  "hostname": "family-mac.local",
  "os": {"system": "Darwin", "release": "...", "machine": "arm64"},
  ...
  "findings": [
    {
      ...
      "code": "NDG.ROUTE.OUTBOUND_HTTPS_REACHABLE",
      "severity": "ok",
      "status": "healthy",
      "confidence": {
        "level": "high",
        "rationale": "A TCP connection completed",
        "evidence_refs": ["evidence-0004"]
      },
      "category": "route",
      "title": "Outbound TCP/443 works",
      "detail": "Internet path appears up via 1.1.1.1.",
      "hint": "",
      "data": {},
      "evidence_refs": ["evidence-0004"],
      "remediation_refs": []
  ...
  "checks": [
    {
      "check_id": "netdiag.check.route",
      "execution_status": "completed",
      "duration_ms": 820,
      "evidence_refs": ["evidence-0001", "evidence-0004"],
      "error": null
    }
  ],
  "evidence": [],
  "access_prerequisites": [],
  "remediation": {"available_actions": [], "attempts": []},
  "data": {}
}
```
