...
For version `0.3.0.dev6` on Apple Silicon, the names are:

```text
lantern-family-beta-0.3.0.dev6-macos-arm64-UNSIGNED-DEV/
lantern-family-beta-0.3.0.dev6-macos-arm64-UNSIGNED-DEV.zip
lantern-family-beta-0.3.0.dev6-macos-arm64-UNSIGNED-DEV.zip.sha256
```
...
metadata uses Apple's numeric forms: `0.3.0.dev6` maps to marketing version `0.3.0` and
bundle build `6`.
...
python3 scripts/verify_family_beta.py \
  ...
  dist/family-beta/lantern-family-beta-0.3.0.dev6-macos-arm64-UNSIGNED-DEV
```
...
```text
lantern-family-beta-0.3.0.dev6-macos-arm64-SIGNED/
lantern-family-beta-0.3.0.dev6-macos-arm64-SIGNED.zip
lantern-family-beta-0.3.0.dev6-macos-arm64-SIGNED.zip.sha256
```
